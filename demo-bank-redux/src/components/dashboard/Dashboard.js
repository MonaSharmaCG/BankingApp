...
function Copyright(props) {
  return (
    ...
    >
         {"Copyright © "}
         <Link color="inherit" href="https://www.capgemini.com/us-en/" target="_blank" rel="noopener">
           Capgemini
      </Link>{" "}
...
export default function Dashboard() {
  // Get transaction history from Redux
  const transactHistory = useSelector(state => state.transactionHistoryReducer);
  const dispatch = useDispatch();
  React.useEffect(() => {
    dispatch(accountActions.getTransactionHistory());
  }, [dispatch]);
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={8} lg={9}>
                ...
                >
                  <Chart transactHistory={transactHistory} />
                </Paper>
              </Grid>
              {/* Recent Deposits */}
